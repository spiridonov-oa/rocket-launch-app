...
export const response1 = {
  ...
  results: [
    ...
    },
    {
      ...
      last_updated: "2021-08-31T20:43:54Z",
    ...
    },
    {
      ...
      last_updated: "2021-08-31T20:43:55Z",
      ...
      pad: {
        ...
        map_image:
          "https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/launch_images/pad_space_launch_complex_26a_20210830170946.jpg",
    ...
    },
    {
      ...
      last_updated: "2021-08-31T20:43:56Z",
    ...
    },
    {
      ...
      last_updated: "2021-08-31T20:43:57Z",
    ...
    },
    {
      ...
      last_updated: "2021-08-31T20:43:58Z",
...
const generateMockData = (url: string): { data: LaunchesResponseI } => {
  let res: any = response1;
  if (url && url?.slice(0, 3) === "url") {
    const num = +url?.slice(3);

    const randomBool = () => {
      return !Math.round(Math.random());
    };

    const results = new Array(10).fill(0).map((v, i) => {
      return {
        id: `id-${num}-${i}`,
        url: "https://ll.thespacedevs.com/2.2.0/launch/e3df2ecd-c239-472f-95e4-2b89b4f75800/?format=api",
        slug: `sputnik-${num}-${i}`,
    ...
    res = { count: 1000, next: "url" + (num + 1), previous: url, results };
    if (num > 100) {
      res = { count: 1000, next: null, previous: url, results: [] };
    }
  }
...
export function mockData(url: string): Promise<{ data: LaunchesResponseI }> {
  const p: Promise<{ data: LaunchesResponseI }> = new Promise((resolve, reject) => {
    setTimeout(() => {
